...
def delete(list_id):
    task_to_delete=Todo.query.get_or_404(list_id)
    ...
    try:
        ...
        return 'Nie mozna usunac listy'
@app.route('/update/<int:list_id>', methods=['GET', 'POST'])
def update(list_id):
    task = Todo.query.get_or_404(list_id)
    if request.method == 'POST':
        ...
        try:
            ...
            return 'Wystąpił błąd przy aktualizacji listy'
    else:
